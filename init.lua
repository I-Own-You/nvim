...
require("lazy").setup({
	...
	},
	{
		...
		init = function()
			...
			vim.g.taboo_tab_format = " %f%m|%W "
			vim.g.taboo_renamed_tab_format = " R:%l%m|%W "
	...
	},
	{
		...
		keys = {
			...
			-- below was defined in keymaps.lua delete them, if deletes the plugin
