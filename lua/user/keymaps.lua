...
keymap("i", "<C-w>", "<C-o>w", { silent = true, desc = "" })
keymap("i", "<C-e>", "<C-o>e", { silent = true, desc = "" })
keymap("i", "<C-b>", "<C-o>b", { silent = true, desc = "" })
...
keymap("i", "<C-BACKSPACE>", "<C-o><Left><C-o>vbd", { silent = true, desc = "" })
